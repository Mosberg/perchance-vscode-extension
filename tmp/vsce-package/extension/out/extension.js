...
function activate(context) {
    ...
    const bundledServerModule = context.asAbsolutePath(path.join("server", "out", "server.js"));
    const devServerModule = context.asAbsolutePath(path.join("..", "server", "out", "server.js"));
    const serverModule = fs.existsSync(bundledServerModule) ? bundledServerModule : devServerModule;
    const serverOptions = {
